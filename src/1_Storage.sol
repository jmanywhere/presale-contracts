...
contract TieredPresale is ITieredPresale, Ownable, ReentrancyGuard {
     ...
     * [1] gridSize               DONE
     * LAYER ONE
     * [2] liquidityBasisPoints.  DONE
     * [3] referralBasisPoints.   DONE
     * OTHER LAYERS
     * [4] liquidityBasisPoints.  DONE
     * [5] referralBasisPoints.   DONE
     * [6] previousLayerBasisPoints DONE
    ...
    constructor(
        ...
        website = projectInfo[0];
        description = projectInfo[1];
        image = projectInfo[2];
        telegram = projectInfo[3];
        twitter = projectInfo[4];
...
contract Factory is ITieredPresaleFactory, Ownable {
    ...
    mapping(address => address[]) public createdGrids;
    ...
    function createPresale(
        ...
        createdGrids[msg.sender].push(address(presale)); // to keep track of users created presales
    ...
    function getUsersPresaleLenght(address _usr) public view returns (uint256) {
        return createdGrids[_usr].length;
    }

    function getUsersPresales(address _usr) public view returns (address[] memory) {
        return createdGrids[_usr];
    }
